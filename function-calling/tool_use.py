...
os.environ["ZHIPUAI_API_KEY"] = getpass.getpass("Enter your ZhiPu API key: ")
try:
...
if llm:
    # This prompt template requires an `agent_scratchpad` place- holder for the agent's internal steps.
    agent_prompt = (
...
async def main():
    ...
    tasks = [
        ...
        run_agent_with_tool("What's the weather like London?"),
        run_agent_with_tool(
